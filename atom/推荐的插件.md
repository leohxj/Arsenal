...
- [align-regexp](https://atom.io/packages/align-regexp): 根据整个对齐
- [atom-alignment](https://atom.io/packages/atom-alignment): 对齐工具
...
- [autoupdate-packages](https://atom.io/packages/autoupdate-packages): 自动升级插件
